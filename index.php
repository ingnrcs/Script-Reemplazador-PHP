 ...
 * OK? If you don't wish to take responsibility, hire us at ingnrcs.tech
 * on +57 (313)819 7896 and we will do the work for you at our hourly rate,
 * minimum 1hr
 *
 * License: GPL v3
 ...
 *
 * Version 4.0:
 * 		* Optimized for PHP 7.2 Version
 * 		* Optimized for Wordpress 2019 Version
 * 		* Timezone Changed to PHP 7.2 America/Bogota
 * 		* Language Changed to Spanish LA
 * Version 3.1.0:
...
class icit_srdb_ui extends icit_srdb {
	...
	public function __construct() {
		...
		// php 7.2 date timezone requirement, shouldn't affect anything
	...
	public function ui() {
			...
			<section class="row row-delete">
				...
				<div class="fields">
					<p>
						...
						Una vez haya terminado haga click en boton<strong>ELIMINAME</strong> para asegurar su servidor
					</p>
				</div>
		...
		<section class="help">
			...
			<h1 class="branding">ingnrcs.tech</h1>

			<h2>Búsqueda segura y reemplazo en la base de datos con datos serializados optimizado para PHP 7.2 y la Version Wordpress 2019 - v4.0 by ingnrcs - ingnrcs.tech</h2>

			<p>Esta herramienta de desarrollador / administrador de sistemas realiza funciones de búsqueda / reemplazo en bases de datos MySQL y puede manejar Arrays y Objetos PHP serializados.</p>

			<p><strong class="red">ADVERTENCIAS!</strong>
				
			Asegúrese de que los datos estén respaldados.
			No nos hacemos responsables de los daños causados ​​por este script o su uso incorrecto.
			La configuración de la conexión de la base de datos se completa automáticamente cuando se detecta WordPress o Drupal, pero puede confundirse con la configuración comentada, por lo que CHECK!
			¡NO hay UNDO!
			Tenga cuidado al ejecutar este script en un servidor de producción.</p>

			<h3>¡No olvides quitarme!</h3>

			<p>Eliminar esta utilidad de su servidor después de su uso haciendo clic en el botón 'ELIMINAME'. Representa una amenaza importante para la seguridad de su base de datos si es maliciosamente utilizado.</p>


			<p><em>No colocamos enlaces en la búsqueda para reemplazar la IU para evitar ver las URL de la secuencia de comandos en nuestros registros de acceso.</em></p>

			<h3>Una vez más, el uso de este script es totalmente bajo su propio riesgo</h3>

			<p>La forma más fácil y segura de usar este script es copiar los archivos y la base de datos de su sitio en una nueva ubicación.
				Entonces, si es necesario, arregla adecuadamente tu .htaccess y wp-config.php. Una vez listo, ejecute este script, seleccione sus tablas (en la mayoría de los casos, todas) y luego entrar en la búsqueda reemplazar cadenas. Puede presionar atrás en su navegador para hacer Esto varias veces, como puede ser requerido en algunos casos.</p>
	...
	public function deleted() {
		...
		<section class="row row-branding">
			...
			<h1><a href="https://ingnrcs.tech/" target="_blank">@ingnrcs</span></a></h1>
		...
		<section class="row row-contribute">
			...
			<div class="content">
				...
				<p>¿Tienes alguna sugerencia?, ¿has encontrado algun error?, ¿deseas contribuir con el codigo?, <a href="https://github.com/ingnrcs/script-reemplazador">Join us on Github!</a></p>
		...
		<section class="row row-blog">
			...
			<div class="content">
				<p><a href="https://ingnrcs.tech/blog/" target="_blank">No pudimos cargar nuestro blog por alguna razón, así que aquí hay un enlace.</a></p>
			</div>
		...
		<section class="row row-products">
			...
			<div class="content">
				<p><a href="https://ingnrcs.tech/tienda/" target="_blank">No pudimos cargar nuestros Productos y Servicios por alguna razon, asi que aqui hay un enlace.</a></p>
			</div>
	...
	public function html( $body ) {
		...
		<head>
			...
			<title>Script - Reemplazador by @ingnrcs</title>
			...
			;(function($){
				...
				srdb = function() {
					...
					$.extend( t, {
						...
						report_tpl: '\
				<p class="main-report">\
				En el proceso de <span data-report="search_replace"></span> fueron escaneados\
				<strong data-report="tables"></strong> tablas con un total de\
				<strong data-report="rows"></strong> filas,\
				<strong data-report="changes"></strong> celdas\
				<span data-report="dry_run"></span> cambiado.\
				<strong data-report="updates"></strong> se realizaron actualizaciones en la base de datos.\
				Todo tomó <strong data-report="time"></strong> segundos.\
				</p>',
						table_report_tpl: '\
				...
				<td data-report="time"></td>',
						...
						strings_dry: {
							search_replace: 'buscando <strong>&ldquo;<span data-report="search"></span>&rdquo;</strong>\
								(para ser reemplazado por <strong>&ldquo;<span data-report="replace"></span>&rdquo;</strong>)',
							updates: 'habría sido'
						},
						strings_live: {
							search_replace: 'reemplazando <strong data-report="search"></strong> con\
								<strong data-report="replace"></strong>',
							updates: 'fueron'
						},

						confirm_strings: {
							live_run: '¿Estás absolutamente listo para ejecutar búsqueda / reemplazo? Asegúrese de que ha hecho una copia de seguridad de su base de datos!',
							modify: '¿Estás absolutamente listo para modificar las tablas? Asegúrese de que ha hecho una copia de seguridad de su base de datos!',
							unload_default: 'NO OLVIDE ELIMINAR ESTE SCRIPT!!!\n\nHAGA CLICK EN ELIMINARME PARA REMOVERLO.',
							unload_running: 'El script aún está en progreso, ¿definitivamente quieres dejar esta página?'
						},
						...
						submit: function( e ) {
							...
							if ( submit == 'submit[delete]' && ! t.running ) {
								if ( ! confirm( '¿Realmente desea eliminar el directorio de script Buscar / Reemplazar y -todo su contenido-?' ) ) {
									t.complete();
									return false;
								}
